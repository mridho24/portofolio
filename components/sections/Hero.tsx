      ...
      <div className="relative z-10 mx-auto w-full max-w-[1280px] px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-5rem)] py-10">
          ...
          <div className="hero-content-left animate-fade-up">
            ...
            <div className="hero-education mt-14">
              <p className="mb-5 text-xs font-semibold uppercase tracking-widest text-muted">
                Education &amp; Achievement
              </p>
              <div className="flex flex-wrap items-center gap-4">
                <div className="hero-badge-item flex items-center gap-3 rounded-2xl border border-peach-300 bg-white/70 backdrop-blur-sm px-5 py-3 shadow-sm hover:-translate-y-0.5 transition-transform duration-300">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-navy/5">
                    <svg className="h-4 w-4 text-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="hero-badge-item flex items-center gap-3 rounded-2xl border border-peach-300 bg-white/70 backdrop-blur-sm px-5 py-3 shadow-sm hover:-translate-y-0.5 transition-transform duration-300">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-orange/8">
                    <svg className="h-4 w-4 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
